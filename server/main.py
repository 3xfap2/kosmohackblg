...
RATE_WINDOW_S = 60
# Пределы выбраны выше рабочего темпа оператора: автопилот запрашивает прогноз каждый час смены,
# а шаги идут пачками. Это защита от перебора запросов, а не квота на работу.
RATE_LIMITS = {"ai": 20, "features": 90, "compute": 120, "other": 300}
